# Measurement-Resolved Complexity Voyage (v0.1, archived)

**ARCHIVED 2026-04-14.** This is the v0.1 of `VOYAGE_PLAN.md`, preserved per T(h)reehouse +EC Corporate Design §0.8 ("Deprecation, not deletion") and §15 (Deprecation Protocol). Superseded by v0.2; see `archive/2026-04-14-VOYAGE_PLAN-v0.1-deprecated.md` for the deprecation reason and the superseding file.

The content below is the v0.1 as it stood immediately before the v0.2 rewrite. It carries four strikethrough-style amendments that v0.2 absorbs cleanly. Do not edit this file further — historical record only.

**Endorsement Marker:** T(h)reehouse +EC voyage plan (v0.1, archived). No external endorsement implied.
